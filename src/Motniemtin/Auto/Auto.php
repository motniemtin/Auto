...
class Auto{
      ...
      public function __construct($cookies = TRUE, $cookie = null, $compression = 'gzip', $proxy = ''){
          ...
          $this->headers[4]   = 'Accept-Language: en-US;q=0.2,en;q=0.2,cs;q=0.2,de;q=0.2,es;q=0.2,id;q=0.2,ja;q=0.2,ro;q=0.2,pt;q=0.2,pl;q=0.2';
      ...
      public function SetAutoProxy($checkExist=true){
        if($checkExist && file_exists(("temp/proxy.ini"))){
      ...
      public function GetImage($fileurl, $image_path){
          $fileurl=str_replace(' ','%20',$fileurl);
          $out      = fopen($image_path,'w');
          if ($out == FALSE) {
              exit(".mtcerror.=> Loi khong the ghi file $fileurl to $image_path");
          }
